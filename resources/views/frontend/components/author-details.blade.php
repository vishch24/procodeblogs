            ...
            @if ($singleBlog->user && $singleBlog->user->img)
                @php
                    if ($singleBlog->user->google_id) {
                        ...
                        $user_img = asset('dashboard/assets/img/avatar/' .$singleBlog->user->img);
                    }
                @endphp
