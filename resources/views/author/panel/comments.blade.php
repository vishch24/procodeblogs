                            ...
                            <table id="datatable" class="table table-bordered table-striped table-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('author.dashboard.comments.edit', $comment->id) }}" class="btn btn-sm btn-primary border-0 rounded-0 shadow-sm"><i class="bi bi-pencil"></i></a>
                                            ...
                                            <x-delete-record-modal title="DeleteCommentRecordModal_{{ $comment->id }}" url="{{ route('author.dashboard.comments.delete', $comment->id) }}"/>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
