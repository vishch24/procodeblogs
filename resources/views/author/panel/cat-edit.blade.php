            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8">
                        <form action="{{ route('author.dashboard.categories.update', $category->id) }}" method="POST">
                            @csrf

                            <div class="form-floating mb-3">
                                <input type="text" class="form-control shadow-sm" id="floatingName" name="name" placeholder="Enter Category Name" value="{{ $category->name }}" required autofocus autocomplete="name">
